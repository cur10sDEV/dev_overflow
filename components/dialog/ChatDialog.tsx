      ...
      {isChatOpen && (
        <AnimatePresence>
          <motion.div
            ...
            className="fixed bottom-28 right-10 z-50 h-[650px] rounded-xl border bg-light-900 px-4 shadow-lg transition-all dark:border-gray-950 dark:bg-dark-400 md:w-[700px]"
          >
                ...
                <ScrollArea className="h-[450px] w-full">
                  ...
                  {messages.length > 0 &&
                    messages.map((msg) => (
                      <div
                        key={msg.id}
                        className={`mb-6 ${msg.role === "user" ? "text-right" : "text-left"} w-auto`}
                      >
                        <div
